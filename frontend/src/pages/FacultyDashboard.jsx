  ...
  return (
    <div className="min-h-screen flex flex-col bg-tcet-lightBg">
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 flex-grow w-full">
        ...
        <div className="border-b-2 border-tcet-gold mb-6 bg-white shadow-sm px-6 py-3 flex justify-between items-center">
          <span className="text-xs font-black uppercase tracking-wider text-tcet-navy">
            Pending Student Reviews
          </span>
          <span className="bg-tcet-navy text-white text-xs font-mono font-bold px-2.5 py-0.5">
